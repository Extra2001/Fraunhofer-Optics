circ_fraunhofer MATLAB .NET Assembly (.NET Component)
...
circ_fraunhofer_overview.html - HTML overview documentation file for the generated 
                                component. It contains the requirements for accessing the 
                                component and for generating arguments using the MWArray 
                                class hierarchy.

circ_fraunhofer.xml - This file contains the code comments for the circ_fraunhofer 
                                ...
                                documentation for the circ_fraunhofer component.
