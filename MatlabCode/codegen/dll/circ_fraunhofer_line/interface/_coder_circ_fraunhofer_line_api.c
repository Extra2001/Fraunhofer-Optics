/*
 * File: _coder_circ_fraunhofer_line_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "circ_fraunhofer_line",              /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
void circ_fraunhofer_line_api(const mxArray * const prhs[7], int32_T nlhs, const
  mxArray *plhs[1])
{
  emxArray_real_T *II;
  real_T D;
  ...
  circ_fraunhofer_line(D, N, sita, lambda, f, xd, yd, II);

  /* Marshall function outputs */
  II->canFreeData = false;
  plhs[0] = emlrt_marshallOut(II);
  emxFree_real_T(&II);
 ...
 * Return Type  : void
 */
void circ_fraunhofer_line_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  circ_fraunhofer_line_xil_terminate();
  circ_fraunhofer_line_xil_shutdown();
 ...
 * Return Type  : void
 */
void circ_fraunhofer_line_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void circ_fraunhofer_line_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_circ_fraunhofer_line_api.c
 *
 * [EOF]
 */
