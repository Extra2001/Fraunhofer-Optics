/*
 * circ_fraunhofer_sil.c
 *
 * Automatically generated host I/O interface for:
 * Component: circ_fraunhofer
 * Execution Mode: SIL
 *
 */
...
#include "_coder_circ_fraunhofer_info.h"
  ...
  if ((pIsXILApplicationStarted != NULL) && (*pIsXILApplicationStarted == 1)) {
    {
      if (pXILUtils) {
        ...
        const char * simulinkBlockPath =
          "C:\\Users\\jingx\\Projects\\fraunhofer-optics\\MatlabCode\\codegen\\dll\\circ_fraunhofer\\circ_fraunhofer";
...
static boolean_T startAndSetupApplication()
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("circ_fraunhofer");
      mxArray *rhs[3];
      const char * simulinkBlockPath =
        "C:\\Users\\jingx\\Projects\\fraunhofer-optics\\MatlabCode\\codegen\\dll\\circ_fraunhofer\\circ_fraunhofer";
      rhs[ 0 ] = mxCreateString(
...
void circ_fraunhofer_xil_terminate()
{
...
void circ_fraunhofer_xil_shutdown()
{
  int commErrorOccurred = 0;
  int isXILApplicationStarted = 0;
