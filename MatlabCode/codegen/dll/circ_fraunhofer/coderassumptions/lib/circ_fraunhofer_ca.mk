...
## Build Info:
## 
## Final product: .\circ_fraunhofer_ca.lib
...
PRODUCT_NAME              = circ_fraunhofer_ca
MAKEFILE                  = circ_fraunhofer_ca.mk
...
COMPILER_COMMAND_FILE     = circ_fraunhofer_ca_comp.rsp
CMD_FILE                  = circ_fraunhofer_ca.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = circ_fraunhofer_ca.lib
...
PRODUCT = .\circ_fraunhofer_ca.lib
...
SRCS = $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\coder_assumptions_hwimpl.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\coder_assumptions_flt.c $(START_DIR)\coderassumptions\circ_fraunhofer_ca.c
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj circ_fraunhofer_ca.obj
...
circ_fraunhofer_ca.obj : $(START_DIR)\coderassumptions\circ_fraunhofer_ca.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\coderassumptions\circ_fraunhofer_ca.c
